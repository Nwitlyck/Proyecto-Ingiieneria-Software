...
Public Class perfil
    ...
    Private Sub Buttondelete_Click(sender As Object, e As EventArgs) Handles Buttondelete.Click
        If TextBoxProducto.Text = "" Then
            MessageBox.Show("Escriba el codigo de producto que desea eliminar")
        Else
    ...
    Private Sub Buttonedit_Click(sender As Object, e As EventArgs) Handles Buttonedit.Click
        If TextBoxNombrePro.Text = "" And TextBoxProducto.Text = "" And TextBoxSupermercado.Text = "" And TextBoxPrecio.Text = "" And TextBoxSupermercado.Text = "" And TextBoxMarca.Text = "" Then
